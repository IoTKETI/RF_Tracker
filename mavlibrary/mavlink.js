...
mavlink.MAVLINK_HEADER_LEN_V2 = 10; //  : (Optional) Signature
...
mavlink.message.prototype.pack = function(mav, crc_extra, payload) {
    ...
    // For now, assume always using crc_extra = True.  : check/fix this.
...
MAVLink.prototype.parsePayload = function() {
    ...
    if( this.expected_length >= header_length && this.buf.length >= this.expected_length ) {
        ...
        // : slicing off the buffer should depend on the error produced by the decode() function
